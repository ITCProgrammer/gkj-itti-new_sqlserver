              ...
              <table id="example5" width="100%" class="table table-sm table-bordered table-hover tree" style="font-size: 13px;">
                <thead class="btn-success">
                  <tr>
                    ...
                    <th>
                      <div align="center">Tgl Proses GKJ</div>
                    </th>
                    <th>
                ...
                <tbody>
                  <?php
                      $sql = "
                          SELECT
                              ...
                              CONVERT(varchar(19), MIN(t.tgl_update), 120) AS tgl_update,  -- yyyy-mm-dd hh:mi:ss
                              CONVERT(varchar(10), MAX(t.tgl_buat), 102) AS tgl_buat,
                              MAX(t.potong_null) AS potong_null
                  ...
                  ?>
                    <tr>
                      ...
                      <td align="center"><a href="#" class="btn btn-warning btn-xs edit_tglproses <?php if ($row['tgl_proses'] != "" and $_SESSION['lvlGKJ'] == "admin" or $_SESSION['lvlGKJ'] == "superadmin") {
                                                                                                  } else {
                                                                                                    echo "disabled";
                                                                                                  } ?>" refno="<?php echo $row['refno']; ?>"><?php if ($row['tgl_proses'] != "") {
                                                                                                                                                echo $row['tgl_proses'];
                                                                                                                                              } else {
                                                                                                                                                echo "Belum Diproses";
                                                                                                                                              } ?></a></td>
                      <td align="center">
                        <?php
                        $sqlket = sqlsrv_query($con, "
                                SELECT DISTINCT jns_permintaan
                                FROM db_qc.tbl_bon_permintaan
                                WHERE refno = ?
                            ", [$row['refno']]);
                        ...
                        ?>
                          <?php if ($rket['jns_permintaan'] == "Bongkaran") { ?>
                            <a href="ProsesBongkaranBon-<?php echo $row['refno']; ?>-<?php echo $rket['jns_permintaan']; ?>-<?php echo $row['id']; ?>" class="btn btn-warning btn-xs <?php if ($row['status'] == "Baru" or $row['status'] == "Approve" or $row['status'] == "Selesai" or $row['status'] == "Terima" or $row['status'] == "Check" or $row['status'] == "Cancel") {
                                                                                                                                                                                        echo "disabled";
                                                                                                                                                                                      } ?>"><?php echo $rket['jns_permintaan']; ?></a>
                          <?php } ?>
                          <?php if ($rket['jns_permintaan'] == "Potong Sample") { ?>
                            <a href="ProsesBon-<?php echo $row['refno']; ?>-<?php echo $rket['jns_permintaan']; ?>-<?php echo $row['id']; ?>" class="btn btn-success btn-xs <?php if ($row['status'] == "Baru" or $row['status'] == "Approve" or $row['status'] == "Selesai" or $row['status'] == "Terima" or $row['status'] == "Check" or $row['status'] == "Cancel") {
                                                                                                                                                                              echo "disabled";
                                                                                                                                                                            } ?>"><?php echo $rket['jns_permintaan']; ?></a>
                          <?php } ?>
                          <?php if ($rket['jns_permintaan'] == "Potong Pass Qty") { ?>
                            <a href="ProsesBon-<?php echo $row['refno']; ?>-<?php echo $rket['jns_permintaan']; ?>-<?php echo $row['id']; ?>" class="btn btn-primary btn-xs <?php if ($row['status'] == "Baru" or $row['status'] == "Approve" or $row['status'] == "Selesai" or $row['status'] == "Terima" or $row['status'] == "Check" or $row['status'] == "Cancel") {
                                                                                                                                                                              echo "disabled";
                                                                                                                                                                            } ?>"><?php echo $rket['jns_permintaan']; ?></a>
                          <?php } ?>
                          <?php if ($rket['jns_permintaan'] == "Potong Sisa") { ?>
                            <a href="ProsesPotongSisa-<?php echo $row['refno']; ?>-<?php echo $rket['jns_permintaan']; ?>-<?php echo $row['id']; ?>" class="btn btn-info btn-xs <?php if ($row['status'] == "Baru" or $row['status'] == "Approve" or $row['status'] == "Selesai" or $row['status'] == "Terima" or $row['status'] == "Check" or $row['status'] == "Cancel") {
                                                                                                                                                                                  echo "disabled";
                                                                                                                                                                                } ?>"><?php echo $rket['jns_permintaan']; ?></a>
                          <?php } ?>
                          <?php if ($rket['jns_permintaan'] == "Ganti Grade") { ?>
                            <a href="ProsesGantiGrade-<?php echo $row['refno']; ?>-<?php echo $rket['jns_permintaan']; ?>-<?php echo $row['id']; ?>" class="btn btn-secondary btn-xs <?php if ($row['status'] == "Baru" or $row['status'] == "Approve" or $row['status'] == "Selesai" or $row['status'] == "Terima" or $row['status'] == "Check" or $row['status'] == "Cancel") {
                                                                                                                                                                                        echo "disabled";
                                                                                                                                                                                      } ?>"><?php echo $rket['jns_permintaan']; ?></a>
                          <?php } ?>
                          ...
                          <?php } ?>
                          <!--<?php if ($row['jns_permintaan'] == "Bongkaran") {
                                echo "<span class='badge badge-warning'>" . $row['jns_permintaan'] . "</span>";
                              } else if ($row['jns_permintaan'] == "Potong Sample") {
                                echo "<span class='badge badge-success'>" . $row['jns_permintaan'] . "</span>";
                              } else if ($row['jns_permintaan'] == "Potong Pass Qty") {
                                echo "<span class='badge badge-primary'>" . $row['jns_permintaan'] . "</span>";
                              } ?>-->
                        <?php } ?>
                      </td>
                      <td align="left">
                        <?php
                        $sqlbon = sqlsrv_query($con, "
                                  SELECT nokk, jns_permintaan, ket, potong_null
                                  FROM db_qc.tbl_bon_permintaan
                                  WHERE refno = ?
                              ", [$row['refno']]);
                      ...
                      <td align="center">
                        <div class="btn-group">
                          <!-- <a href="#" class="btn btn-danger btn-xs <?php if ($row['status'] == "Cancel" or $row['status'] == "Selesai" or $row['status'] == "Sedang Proses") {
                                                                          echo "disabled";
                                                                        } ?>" onclick="confirm_cancel('CancelBon-<?php echo $_SESSION['userGKJ']; ?>-<?php echo $row['refno']; ?>-<?php echo $row['tgl_buat']; ?>-<?php echo $_SESSION['jabatanGKJ']; ?>');"><i class="fa fa-times-circle" data-toggle="tooltip" data-placement="top" title="Cancel"></i> </a> -->
                          <a href="CancelDetailBon-<?php echo $row['refno']; ?>" class="btn btn-danger btn-xs <?php if ($row['status'] == "Cancel" or $row['status'] == "Selesai" or $row['status'] == "Sedang Proses") {
                                                                                                                echo "disabled";
                                                                                                              } ?>"><i class="fa fa-times-circle" data-toggle="tooltip" data-placement="top" title="Cancel"></i> </a>
                          ...
                          <a href="TambahDetailBon-<?php echo $row['refno']; ?>" class="btn btn-info btn-xs <?php if ($row['status'] == "Approve" or $row['status'] == "Check" or $row['status'] == "Selesai" or $row['status'] == "Baru" or $row['status'] == "Cancel" or $row['status'] == "Terima") {
                                                                                                              echo "disabled";
                                                                                                            } ?>"><i class="fa fa-plus" data-toggle="tooltip" data-placement="top" title="Tambah Detail"></i> </a>
                          <?php if ($row['potong_null'] == '1' and $row['status'] == "Approve") { ?>
                            <a href="pages/cetak/bon-permintaan-ptgnull.php?bon=<?php echo $row['refno']; ?>&tgl=<?php echo substr($row['tgl_update'], 0, 10); ?>" class="btn btn-primary btn-xs  <?php if (($row['status'] == "Approve" and $row['potong_null'] == '0') or $row['status'] == "Check" or $row['status'] == "Baru" or $row['status'] == "Cancel" or $row['status'] == "Terima") {
                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                  } ?>" target="_blank"><i class="fa fa-print" data-toggle="tooltip" data-placement="top" title="Cetak"></i> </a>
                          <?php } else { ?>
                            <a href="pages/cetak/bon-permintaan.php?bon=<?php echo $row['refno']; ?>&tgl=<?php echo substr($row['tgl_update'], 0, 10); ?>" class="btn btn-primary btn-xs  <?php if ($row['status'] == "Approve" or $row['status'] == "Check" or $row['status'] == "Baru" or $row['status'] == "Cancel" or $row['status'] == "Terima") {
                                                                                                                                                                                            echo "disabled";
                                                                                                                                                                                          } ?>" target="_blank"><i class="fa fa-print" data-toggle="tooltip" data-placement="top" title="Cetak"></i> </a>
                          <?php } ?>
                          <a href="#" class="btn btn-success btn-xs <?php if ($row['status'] == "Sedang Proses" or $row['status'] == "Terima" or $row['status'] == "Baru" or $row['status'] == "Selesai" or $row['status'] == "Check" or $row['status'] == "Cancel") {
                                                                      echo "disabled";
                                                                    } ?>" onclick="confirm_terima('TerimaBon-<?php echo trim($row['refno']); ?>-<?php echo $row['tgl_buat']; ?>-<?php echo $_SESSION['userGKJ']; ?>-<?php echo $_SESSION['jabatanGKJ']; ?>');"><i class="fa fa-check-circle" data-toggle="tooltip" data-placement="top" title="Terima"></i> </a>
                          <a href="#" class="btn btn-primary btn-xs <?php if ($row['status'] == "Baru" or $row['status'] == "Selesai" or $row['status'] == "Approve" or $row['status'] == "Sedang Proses" or $row['status'] == "Check" or $row['status'] == "Cancel") {
                                                                      echo "disabled";
                                                                    } ?>" onclick="confirm_proses('SProsesBon-<?php echo trim($row['refno']); ?>-<?php echo $row['tgl_buat']; ?>-<?php echo $_SESSION['userGKJ']; ?>-<?php echo $_SESSION['jabatanGKJ']; ?>');"><i class="fa fa-spinner" data-toggle="tooltip" data-placement="top" title="Proses"></i> </a>
                          <a href="#" class="btn btn-warning btn-xs <?php if ($row['status'] == "Baru" or $row['status'] == "Terima" or $row['status'] == "Selesai" or $row['status'] == "Approve" or $row['status'] == "Check" or $row['status'] == "Cancel") {
                                                                      echo "disabled";
                                                                    } ?>" onclick="confirm_selesai('SelesaiBon-<?php echo trim($row['refno']); ?>-<?php echo $row['tgl_buat']; ?>-<?php echo $_SESSION['userGKJ']; ?>-<?php echo $_SESSION['jabatanGKJ']; ?>');"><i class="fa fa-flag-checkered" data-toggle="tooltip" data-placement="top" title="Selesai"></i> </a>
                        </div>
                      </td>
                    </tr>
                  <?php $n++;
