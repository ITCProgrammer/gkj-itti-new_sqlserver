                        ...
                        <div class="col-sm-12">		
                            ...
                            <div class="form-group row">
                                <label for="nokk" class="col-md-3">No KK</label>
                                    <div class="col-md-4">  
                                        <select class="form-control select2" name="nokk" id="nokk" onchange="window.location='index1.php?page=prosesganti_grade&amp;bon=<?php echo $_GET['bon'];?>&amp;jns=<?php echo $_GET['jns'];?>&amp;id=<?php echo $_GET['id'];?>&amp;nokk='+this.value">
                                            <option value=""></option>
                                            <?php 
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body table-responsive">
                    <table id="example8" width="100%" class="table table-sm table-bordered table-hover" style="font-size: 12px;">
	...
	<div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <!-- /.card-header -->
                    <input name="idsave" type="hidden" class="form-control  form-control-sm" id="idsave" placeholder="" value="<?php echo $id; ?>" >
                    <input name="no_docsave" type="hidden" class="form-control  form-control-sm" id="no_docsave" placeholder="" value="<?php echo $nodoc; ?>" >
                    <input name="nobonsave" type="hidden" class="form-control  form-control-sm" id="nobonsave" placeholder="" value="<?php echo $Bon; ?>" >
                    <input name="nokksave" type="hidden" class="form-control  form-control-sm" id="nokksave" placeholder="" value="<?php echo $Nokk; ?>" >
                    <input name="jenissave" type="hidden" class="form-control  form-control-sm" id="jenissave" placeholder="" value="<?php echo $Jenis; ?>" >
                    <input name="tgloutsave" type="hidden" class="form-control  form-control-sm" id="tgloutsave" placeholder="" value="<?php echo $tglTransaksi; ?>" >
                    <input name="shiftsave" type="hidden" class="form-control  form-control-sm" id="shiftsave" placeholder="" value="<?php echo $Shift; ?>" >
                    <input name="ketsave" type="hidden" class="form-control  form-control-sm" id="ketsave" placeholder="" value="<?php echo $DataKet; ?>" >
                    <input name="useridsave" type="hidden" class="form-control  form-control-sm" id="useridsave" placeholder="" value="<?php echo $_SESSION['userGKJ']; ?>">
                <div class="card-body table-responsive">
                    <table id="example9" width="100%" class="table table-sm table-bordered table-hover" style="font-size: 12px;">
                        ...
                        <tr>
                            ...
                            <th><div align="center" valign="middle">Tgl Mutasi</div></th>
                            <td><div align="center" valign="middle"><input type="checkbox" name="allbox2" value="check" onclick="checkAll2(0);" /></div></td>
                        </tr>
                        </thead>  
                        <tbody>
                        <?php
...
if(isset($_POST['tambah'])){
    ...
    $no++;
        ...
        if($sqlInsert){
            echo "<script>window.location='index1.php?page=prosesganti_grade&bon=$Bon&jns=$Jenis&id=$id1&nokk=$Nokk&tgl=$tgl&ket=$ket1&shift=$shift1';</script>"; 
        }
    }
...
if(isset($_POST['save'])){
    if($_POST['jenis']=="Bongkaran"){$ket = 'Tolakan';}else if($_POST['jenis']=="Ganti Grade"){$ket = 'Ganti Grade';}else if($_POST['jenis']=="Potong Pass Qty"){$ket = 'Potong Sample, Potong Pass Qty';}else if($_POST['jenis']=="Potong Sisa"){$ket= 'Revisi Stiker';}
	else{$ket = $_POST['jenis'];}
    $txtKeterangan	= $_POST['ketsave'];
	$cmbTanggal 	= $_POST['tgloutsave'];
	$txtDok			= $_POST['no_dok'];
	$tgl_update		= $_POST['tgloutsave'];
	$documentno		= $_POST['no_docsave'];
	$tgl_sj			= $_POST['tgloutsave'];
    $shift			= $_POST['shiftsave'];
	$barcode 		= $_POST['barcode'];
	$id 			= $_POST['idsave'];
    ...
    $sqldelete = mysqli_query($con,"DELETE FROM tmp_detail_pergerakan_stok WHERE transtatus='2' AND userid='$Usernm'");
    if($sqlInsert1){
        echo "<script>window.location='index1.php?page=prosesganti_grade&bon=$Bon&jns=$Jenis&id=$id1&nokk=$Nokk';</script>"; 
          }
  }
?> 
...
function checkAll2(form3){
    for (var i=0;i<document.forms['form3'].elements.length;i++)
    {
        ...
        {
            e.checked=document.forms['form3'].allbox2.checked;
